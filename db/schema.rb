...
ActiveRecord::Schema.define(version: 2021_06_14_201207) do
  ...
  create_table "worker_centers", force: :cascade do |t|
    t.integer "worker_id", null: false
    t.integer "medical_center_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["medical_center_id"], name: "index_worker_centers_on_medical_center_id"
    t.index ["worker_id"], name: "index_worker_centers_on_worker_id"
  end
  ...
  add_foreign_key "worker_centers", "medical_centers"
  add_foreign_key "worker_centers", "workers"
